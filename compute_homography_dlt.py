...
def visualize_homography_mapping(
    ...
    dst_points,
    mapped_points,
    test_src_points=None,
    test_dst_points=None,
    test_mapped_points=None,
):
    """
    ...
    try:
        ...
        if (
            test_src_points is not None
            and test_dst_points is not None
            and test_mapped_points is not None
        ):
        ...
        handles = [
            ...
            plt.Line2D(
                ...
                markerfacecolor="b",
                markersize=10,
                label="Training Destination Points",
            ),
            plt.Line2D(
                [0],
                [0],
...
def main():
    ...
    print(
        f"Using {len(src_points)} points for homography estimation and {len(test_src_points)} points for testing"
    )
